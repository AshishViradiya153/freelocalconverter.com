...
export const LLMS_SECTIONS: LlmsSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/gif-tools", label: "GIF and motion tools" },
      { path: "/image-base64", label: "Image Base64 and data URL" },
      { path: "/svg-to-png", label: "SVG to PNG multi-size" },
      { path: "/open-graph-preview", label: "Open Graph preview" },
