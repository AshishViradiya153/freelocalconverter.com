...
export const skaterSchema = z.object({
  ...
  stance: z.enum(SKATER_STANCES),
  style: z.enum(SKATER_STYLES),
  status: z.enum(SKATER_STATUSES),
...
export const insertSkaterSchema = z.object({
  ...
  stance: z.enum(SKATER_STANCES).optional(),
  style: z.enum(SKATER_STYLES).optional(),
  status: z.enum(SKATER_STATUSES).optional(),
