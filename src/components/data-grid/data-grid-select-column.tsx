...
import { DataGridSelectRowMenu } from "@/components/data-grid/data-grid-select-row-menu";
...
function DataGridSelectCell<TData>({
  ...
  return (
    <div className="flex w-full min-w-0 items-center gap-0 pe-0.5">
      ...
      <DataGridSelectRowMenu table={table} rowId={row.id} />
    </div>
  );
}
