...
export function DataGridHeaderCell<TData>({
  ...
  const columnReorderHandle = reorderByDraggingHeader ? (
    <SortableItemHandle
      ...
      className={cn(
        ...
        "pointer-events-none w-0 min-w-0 max-w-0 p-0 opacity-0",
        "transition-[width,max-width,min-width,opacity] duration-150 ease-out",
        "group-hover/grid-header-cell:pointer-events-auto group-hover/grid-header-cell:w-7 group-hover/grid-header-cell:min-w-7 group-hover/grid-header-cell:max-w-7 group-hover/grid-header-cell:opacity-100",
        "data-dragging:pointer-events-auto data-dragging:w-7 data-dragging:min-w-7 data-dragging:max-w-7 data-dragging:opacity-100",
        "focus-visible:pointer-events-auto focus-visible:w-7 focus-visible:min-w-7 focus-visible:max-w-7 focus-visible:opacity-100",
  ...
  if (reorderByDraggingHeader) {
    const reorderInner = header.isPlaceholder ? null : typeof header.column
